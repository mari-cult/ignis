//! Adapted from winit `src/platform_impl/linux/common/xkb/keymap.rs`.

use bevy::input::{
    ButtonState,
    keyboard::{Key, KeyCode, NativeKey, NativeKeyCode},
};
use smithay::backend::input::KeyState as SmithayButtonState;

/// Convert an X11 keycode to a [`KeyCode`].
///
/// X11 keycodes are Linux scancodes offset by 8.
pub fn convert_keycode(keycode: u32) -> KeyCode {
    convert_scancode(keycode.saturating_sub(8))
}

/// Convert a Linux scancode to a [`KeyCode`].
pub fn convert_scancode(scancode: u32) -> KeyCode {
    match scancode {
...
pub fn convert_keycode_logical(keycode: u32) -> Key {
    convert_scancode_logical(keycode.saturating_sub(8))
}

pub fn convert_scancode_logical(scancode: u32) -> Key {
    match scancode {
        0 => Key::Unidentified(NativeKey::Xkb(0)),
        1 => Key::Escape,
        14 => Key::Backspace,
        15 => Key::Tab,
        28 => Key::Enter,
        ...
        110 => Key::Insert,
        111 => Key::Delete,
        113 => Key::AudioVolumeMute,
        114 => Key::AudioVolumeDown,
        115 => Key::AudioVolumeUp,
        119 => Key::Pause,
        127 => Key::ContextMenu,
        163 => Key::MediaTrackNext,
        164 => Key::MediaPlayPause,
        165 => Key::MediaTrackPrevious,
        166 => Key::MediaStop,
        183 => Key::F13,
        184 => Key::F14,
        185 => Key::F15,
        ...
        193 => Key::F23,
        194 => Key::F24,
        240 => Key::Unidentified(NativeKey::Unidentified),
        _ => Key::Unidentified(NativeKey::Xkb(scancode)),
    }
}

pub fn convert_state(state: SmithayButtonState) -> ButtonState {
    match state {
